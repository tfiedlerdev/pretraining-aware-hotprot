...
class FSTHotProt(Module):
    def __init__(
        self,
        hotprot_model,
        esm_model: ESMModelType = "esm2_t33_650M_UR50D",
        ...
        alphabet_cache_path = (
            f"cache/alphabet_{esm_model}_{factorized_sparse_tuning_rank}.pt"
        )
        if exists(model_cache_path) and exists(alphabet_cache_path):
            ...
            self.fst_esm, self.alphabet = load_model_and_alphabet_hub(
                esm_model, True, factorized_sparse_tuning_rank
            )
